  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body d-flex align-items-center img-container">
        <img id="imageModal" src="Upload/<%=rs("AnexoPortfolio")%>" class="img-fluid mx-auto d-block north" alt="..." style="height: 400px; width:400px" >
      </div>
...
<div class="container">
<form action="frm_portfolio.asp" method=post>
...
%>
      <tr>
        <td>
 <a href="frm_portfolio.asp?evt=alt&cod=<%=rs("id_CadPortfolio")%>">
